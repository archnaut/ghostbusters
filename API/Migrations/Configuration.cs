...
namespace API.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<API.Infrastructure.DataContext>
    {
        ...
        private void SeedTickets(DataContext context)
        {
            ...
            {
                new Ticket(57, "VIP", 57, 100),
                new Ticket(33, "VIP", 79, 100),
                new Ticket(13, "VIP", 79, 100),
                new Ticket(38, "General Admission", 118, 100),
                new Ticket(88, "VIP", 145, 100),
                new Ticket(19, "VIP", 122, 100),
                new Ticket(32, "VIP", 59, 100),
                new Ticket(53, "VIP", 101, 100),
                new Ticket(11, "VIP", 54, 100),
                new Ticket(43, "VIP", 136, 100),
                new Ticket(37, "General Admission", 66, 100),
                new Ticket(30, "VIP", 65, 100),
                new Ticket(85, "General Admission", 119, 100),
                new Ticket(96, "General Admission", 131, 100),
                new Ticket(48, "VIP", 68, 100),
                new Ticket(57, "VIP", 149, 100),
                new Ticket(91, "General Admission", 122, 100),
                new Ticket(93, "VIP", 63, 100),
                new Ticket(46, "General Admission", 126, 100),
                new Ticket(1, "VIP", 142, 100),
                new Ticket(39, "General Admission", 112, 100),
                new Ticket(93, "General Admission", 101, 100),
                new Ticket(62, "General Admission", 96, 100),
                new Ticket(77, "General Admission", 131, 100),
                new Ticket(65, "General Admission", 106, 100),
                new Ticket(1, "General Admission", 99, 100),
                new Ticket(93, "General Admission", 137, 100),
                new Ticket(73, "General Admission", 59, 100),
                new Ticket(15, "General Admission", 148, 100),
                new Ticket(41, "VIP", 77, 100),
                new Ticket(26, "General Admission", 114, 100),
                new Ticket(38, "General Admission", 80, 100),
                new Ticket(60, "VIP", 128, 100),
                new Ticket(54, "VIP", 109, 100),
                new Ticket(55, "VIP", 63, 100),
                new Ticket(32, "General Admission", 149, 100),
                new Ticket(100, "VIP", 114, 100),
                new Ticket(34, "General Admission", 138, 100),
                new Ticket(74, "General Admission", 112, 100),
                new Ticket(69, "General Admission", 106, 100),
                new Ticket(74, "General Admission", 132, 100),
                new Ticket(79, "VIP", 88, 100),
                new Ticket(93, "VIP", 117, 100),
                new Ticket(74, "General Admission", 141, 100),
                new Ticket(94, "VIP", 132, 100),
                new Ticket(1, "VIP", 77, 100),
                new Ticket(10, "General Admission", 132, 100),
                new Ticket(2, "General Admission", 80, 100),
                new Ticket(43, "General Admission", 73, 100),
                new Ticket(16, "VIP", 96, 100),
                new Ticket(14, "VIP", 82, 100),
                new Ticket(63, "General Admission", 70, 100),
                new Ticket(4, "VIP", 146, 100),
                new Ticket(57, "General Admission", 130, 100),
                new Ticket(56, "VIP", 143, 100),
                new Ticket(2, "VIP", 107, 100),
                new Ticket(98, "VIP", 113, 100),
                new Ticket(70, "VIP", 143, 100),
                new Ticket(24, "General Admission", 95, 100),
                new Ticket(15, "General Admission", 54, 100),
                new Ticket(8, "VIP", 147, 100),
                new Ticket(22, "VIP", 77, 100),
                new Ticket(32, "General Admission", 113, 100),
                new Ticket(81, "General Admission", 127, 100),
                new Ticket(28, "VIP", 88, 100),
                new Ticket(18, "General Admission", 96, 100),
                new Ticket(20, "General Admission", 149, 100),
                new Ticket(23, "General Admission", 50, 100),
                new Ticket(26, "VIP", 87, 100),
                new Ticket(79, "VIP", 106, 100),
                new Ticket(23, "VIP", 114, 100),
                new Ticket(51, "VIP", 88, 100),
                new Ticket(35, "VIP", 92, 100),
                new Ticket(65, "VIP", 94, 100),
                new Ticket(16, "General Admission", 118, 100),
                new Ticket(17, "VIP", 121, 100),
                new Ticket(1, "General Admission", 86, 100),
                new Ticket(2, "General Admission", 118, 100),
                new Ticket(34, "VIP", 64, 100),
                new Ticket(57, "General Admission", 70, 100),
                new Ticket(70, "VIP", 57, 100),
                new Ticket(49, "VIP", 61, 100),
                new Ticket(100, "General Admission", 148, 100),
                new Ticket(83, "VIP", 100, 100),
                new Ticket(48, "VIP", 91, 100),
                new Ticket(96, "VIP", 106, 100),
                new Ticket(37, "VIP", 121, 100),
                new Ticket(32, "VIP", 58, 100),
                new Ticket(60, "VIP", 95, 100),
                new Ticket(93, "General Admission", 54, 100),
                new Ticket(5, "VIP", 62, 100),
                new Ticket(51, "General Admission", 90, 100),
                new Ticket(6, "VIP", 130, 100),
                new Ticket(18, "General Admission", 138, 100),
                new Ticket(57, "General Admission", 50, 100),
                new Ticket(66, "General Admission", 129, 100),
                new Ticket(20, "General Admission", 71, 100),
                new Ticket(42, "VIP", 99, 100),
                new Ticket(97, "VIP", 146, 100),
                new Ticket(72, "VIP", 100, 100)
            }
                );
